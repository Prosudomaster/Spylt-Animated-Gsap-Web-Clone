      ...
      <div className="container mx-auto pt-20">
        <div className="col-center">
          ...
          <div className="mt-20 col-center">
            <ClipPathTitle title={"Shelf stabe"} color={"#faeade"} bg={"#c88e64"} className={"first-title"} borderColor={"#222123"}/>
            ...
            <ClipPathTitle title={"Lactose free"} color={"#2E2D2F"} bg={"#FED755"} className={"fourth-title"} borderColor={"#222123"}/>
          </div>
